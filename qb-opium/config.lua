...
Config.CircleZones = {
	PickupOpium = {coords = vector3(3265.01, -153.27, 18.6), name = 'blip_PickupOpium', color = 25, sprite = 496, radius = 30.0},
	ProcessOpium = {coords = vector3(1208.68, -3115.82, 5.54), name = 'blip_ProcessOpium', color = 25, sprite = 496, radius = 100.0},
